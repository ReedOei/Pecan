...
def main():
    ...
    parser.add_argument('--output-files', help='Writes the names of all the files generated by the Pecan program to standard output when Pecan exists. Useful for running headless on a server to gather the result files.', required=False, action='store_true')
    ...
    settings.set_output_files(args.output_files)
    ...
    if settings.get_output_files():
        print('GENERATED_FILES', prog.get_generated_files())
