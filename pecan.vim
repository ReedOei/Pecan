...
syntax keyword keywords is are forall exists not or and if then match end case else only with let in be do iff max min sup inf
...
syntax keyword directive that using of
